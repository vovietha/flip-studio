const increaseBtn = document.getElementById('cart-button-increase')
const decreaseBtn = document.getElementById('cart-button-decrease')
...
$(document).ready(function () {
  ...
  $('#addToCartBtn').click(function (e) {
    ...
    var product_qty = $(this).closest('#product_data').find('#cart-input-number').val();
