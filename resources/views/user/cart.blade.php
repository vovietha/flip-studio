...
@section('content')
  <div class="px-5 md:px-0" id="product_data">
    ...
    <div class="text-center my-12 space-y-2">
      <h1 class="text-lg">CART IS EMPTY</h1>
      <a href="{{url('shop/all-products')}}" class="flex items-center justify-center space-x-3">
        <p class="underline text-xs">CONTINUE TO SHOPPING</p> 
