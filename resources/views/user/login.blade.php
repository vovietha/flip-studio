...
@section('content')
  <div class="flex flex-col item-center mx-auto max-w-7xl mb-0 py-20 md:py-10">
    ...
    <div class="flex flex-col md:flex-row justify-between">
      {{-- LOGIN --}}
      <form class="login-form flex flex-col w-full px-5 py-5 md:px-20 md:py-0 space-y-6 mb-10 md:mb-0 border-r-0 md:border-r-[1px] border-[#ccc] bg-black md:bg-white">
